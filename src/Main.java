...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Subtask subtask1 = new Subtask("Название сабтаски1", "Описание сабтаски1",0);
        Subtask subtask2 = new Subtask("Название сабтаски2", "Описание сабтаски2",0);
        Subtask subtask3 = new Subtask("Название сабтаски3", "Описание сабтаски3",1);
        ...
        System.out.println(taskManager.getSubTaskById(0));
